    ...
    try:
        ...
        if 'properties' in schema and 'analysis' in schema['properties']:
            ...
            if 'type' not in analysis_field:
                print("  ✗ ISSUE: Analysis field missing 'type' key - this will cause OpenAI API issues!")
            else:
        ...
        if 'properties' in schema and 'sub_sections' in schema['properties']:
            ...
            if 'items' in sub_sections_field:
                ...
                if 'anyOf' in items_schema or 'oneOf' in items_schema:
                    ...
                    print("  ⚠️  Union not represented as anyOf/oneOf - may cause issues")
        ...
        mda_analysis = MDAAnalysisSection(
            ...
            market_conditions=[
                MarketCondition(
                    ...
                    opportunity_threats=["AI integration opportunity", "Regulatory risk"]
                )
            ],
...
def main():
    ...
    if not schema_ok:
        ...
        print("The 'analysis' field with type 'Any' is problematic for structured output.")
        print("Need to fix the schema definitions to work with OpenAI's structured output.")
