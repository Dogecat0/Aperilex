...
class TestOpenAIProvider:
    ...
    def test_init_with_settings_credentials(self, mock_settings):
        ...
        with patch(
            ...
            # This test verifies the provider uses settings correctly for API key/URL
    ...
    async def test_extract_subsection_text_success(
        ...
        with patch.object(
            ...
            section_text = (
                "Full section text with operational details and financial data."
            )
    ...
    async def test_analyze_section_success(self, provider: OpenAIProvider) -> None:
        ...
        mock_summary_response.usage = Mock()
        mock_summary_response.usage.prompt_tokens = 100
        mock_summary_response.usage.completion_tokens = 50
    ...
    async def test_analyze_filing_comprehensive(self, provider: OpenAIProvider) -> None:
        ...
        mock_overall_response.usage = Mock()
        mock_overall_response.usage.prompt_tokens = 100
        mock_overall_response.usage.completion_tokens = 50
