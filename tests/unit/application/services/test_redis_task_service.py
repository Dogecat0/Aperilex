...
class TestTaskServiceBackendSwitching:
    ...
    @pytest.mark.asyncio
    async def test_create_task_redis_backend(
    ...
    @pytest.mark.asyncio
    async def test_get_task_status_redis_backend(
        self, task_service_redis, mock_redis_service
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_task_status_not_found_redis(
        self, task_service_redis, mock_redis_service
    ):
    ...
    @pytest.mark.asyncio
    async def test_update_task_progress_redis(
        self, task_service_redis, mock_redis_service
    ):
...
class TestTaskServiceRedisFailover:
    ...
    async def test_redis_failure_fallback_to_memory(self, mock_redis_service):
        ...
        task_response = await task_service.create_task(
            task_type="test_task", parameters={}
        )
...
class TestTaskServiceDataConsistency:
    ...
    @pytest.mark.asyncio
    async def test_datetime_serialization_consistency(
        self, task_service_redis, mock_redis_service
    ):
        ...
        await task_service_redis.create_task(task_type="test_task", parameters={})
