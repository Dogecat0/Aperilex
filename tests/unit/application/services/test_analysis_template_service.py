...
class TestAnalysisTemplateService:
    ...
    def test_template_schema_mapping_comprehensive(self, service: AnalysisTemplateService) -> None:
        ...
        assert service.TEMPLATE_SCHEMA_MAPPING[AnalysisTemplate.COMPREHENSIVE] == expected

    def test_template_schema_mapping_financial_focused(self, service: AnalysisTemplateService) -> None:
        ...
        assert service.TEMPLATE_SCHEMA_MAPPING[AnalysisTemplate.FINANCIAL_FOCUSED] == expected

    def test_template_schema_mapping_risk_focused(self, service: AnalysisTemplateService) -> None:
        """Test RISK_FOCUSED template maps to risk schemas."""
        expected = [
            "RiskFactorsAnalysisSection",
            "MDAAnalysisSection",
        ]
        assert service.TEMPLATE_SCHEMA_MAPPING[AnalysisTemplate.RISK_FOCUSED] == expected

    def test_template_schema_mapping_business_focused(self, service: AnalysisTemplateService) -> None:
        """Test BUSINESS_FOCUSED template maps to business schemas."""
        expected = [
            "BusinessAnalysisSection",
            "MDAAnalysisSection",
        ]
        assert service.TEMPLATE_SCHEMA_MAPPING[AnalysisTemplate.BUSINESS_FOCUSED] == expected
    ...
    def test_get_template_by_name_valid(self, service: AnalysisTemplateService) -> None:
        ...
        assert service.get_template_by_name("comprehensive") == AnalysisTemplate.COMPREHENSIVE
    ...
    def test_validate_template_comprehensive(self, service: AnalysisTemplateService) -> None:
    ...
    def test_validate_template_financial_focused(self, service: AnalysisTemplateService) -> None:
    ...
    def test_map_template_to_schemas_financial_focused(self, service: AnalysisTemplateService) -> None:
    ...
    def test_estimate_processing_time_minutes(self, service: AnalysisTemplateService) -> None:
        ...
        comprehensive_time = service.estimate_processing_time_minutes(AnalysisTemplate.COMPREHENSIVE)
    ...
    def test_get_template_info_comprehensive(self, service: AnalysisTemplateService) -> None:
        ...
        assert result["description"] == "Comprehensive analysis covering all business areas"
    ...
    def test_get_all_templates_info(self, service: AnalysisTemplateService) -> None:
        ...
        for info in result:
            required_keys = [
                "name", "description", "schemas", "schema_count", 
                "estimated_time_minutes", "is_custom"
            ]
    ...
    def test_service_immutability(self, service: AnalysisTemplateService) -> None:
        ...
        original_comprehensive = service.TEMPLATE_SCHEMA_MAPPING[AnalysisTemplate.COMPREHENSIVE].copy()
        ...
        assert service.TEMPLATE_SCHEMA_MAPPING[AnalysisTemplate.COMPREHENSIVE] == original_comprehensive

    def test_consistency_with_analyze_filing_command(self, service: AnalysisTemplateService) -> None:
        ...
        comprehensive_schemas = service.map_template_to_schemas(AnalysisTemplate.COMPREHENSIVE)
        ...
        financial_schemas = service.map_template_to_schemas(AnalysisTemplate.FINANCIAL_FOCUSED)
