...
from src.application.handlers_registry import register_handlers, get_configured_dispatcher
...
from src.application.queries.handlers.get_analysis_handler import GetAnalysisQueryHandler
from src.application.queries.handlers.get_filing_handler import GetFilingQueryHandler
from src.application.queries.handlers.get_templates_handler import GetTemplatesQueryHandler
from src.application.queries.handlers.list_analyses_handler import ListAnalysesQueryHandler
from src.application.queries.handlers.get_analysis_by_accession_handler import GetAnalysisByAccessionQueryHandler
from src.application.queries.handlers.get_company_query_handler import GetCompanyQueryHandler
from src.application.queries.handlers.get_filing_by_accession_handler import GetFilingByAccessionQueryHandler
...
class TestRegisterHandlers:
    ...
    def test_register_handlers_calls_all_registrations(
        ...
        mock_dispatcher.register_command_handler.assert_called_once_with(AnalyzeFilingCommandHandler)
        ...
        assert mock_dispatcher.register_query_handler.call_count == 7
        ...
        # Verify logging
        assert mock_logger.info.call_count == 3  # Start command, start query, completion
    ...
    def test_register_handlers_with_dispatcher_error(
        ...
        mock_dispatcher.register_command_handler.side_effect = Exception("Registration failed")
    ...
    def test_register_handlers_partial_failure(
        ...
        mock_dispatcher.register_query_handler.side_effect = Exception("Query registration failed")
...
class TestGetConfiguredDispatcher:
    ...
    def test_get_configured_dispatcher_returns_dispatcher(self) -> None:
        ...
        with patch('src.application.handlers_registry.register_handlers') as mock_register:
    ...
    def test_get_configured_dispatcher_calls_register_handlers(self) -> None:
        ...
        with patch('src.application.handlers_registry.Dispatcher') as mock_dispatcher_class, \
             patch('src.application.handlers_registry.register_handlers') as mock_register:
...
class TestHandlerRegistrationIntegration:
    ...
    def test_handler_type_methods_return_correct_types(self) -> None:
        ...
        from src.application.queries.handlers.get_templates_handler import GetTemplatesQuery
        ...
        assert GetAnalysisByAccessionQueryHandler.query_type() == GetAnalysisByAccessionQuery
        assert GetCompanyQueryHandler.query_type() == GetCompanyQuery
        assert GetFilingByAccessionQueryHandler.query_type() == GetFilingByAccessionQuery
    ...
    def test_complete_handler_registration_integration(self) -> None:
        ...
        assert len(dispatcher._query_handlers) == 7   # 7 query handlers
        ...
        assert dispatcher._command_handlers[AnalyzeFilingCommand] == AnalyzeFilingCommandHandler
...
class TestHandlerRegistryLogging:
    ...
    def test_registration_logging_order(self) -> None:
        ...
        completion_index = log_calls.index("Handler registration completed successfully")
