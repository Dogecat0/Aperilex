...
class TestAnalysis:
    ...
    def test_comprehensive_analysis_workflow(self):
        ...
        analysis.update_results(
            {
                ...
                "risk_factors": ["Market saturation", "Supply chain disruption"],
                "opportunities": ["Services expansion", "Emerging markets"],
            }
        )
        ...
        assert (
            analysis.get_filing_summary()
            == "Apple Inc. shows strong financial performance"
        )
