...
class AnalysisType(str, Enum):
    ...
    COMPREHENSIVE = "comprehensive"  # Comprehensive analysis (alias for filing_analysis)
...
class Analysis:
    ...
    def is_filing_analysis(self) -> bool:
        ...
        """
        return self._analysis_type in (AnalysisType.FILING_ANALYSIS, AnalysisType.COMPREHENSIVE)
