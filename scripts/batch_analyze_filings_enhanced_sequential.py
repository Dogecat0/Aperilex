...
class EnhancedBatchAnalyzer:
    ...
    async def run(
        ...
        try:
            ...
            # Process companies sequentially, filings concurrently
            for _, (company, filings) in company_filings_map.items():
                await self.analyze_company_filings(company, filings, analysis_template)
