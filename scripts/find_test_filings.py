...
def main():
    ...
    try:
        ...
        print(f"   1. Navigate to the filing browser")
        print(f"   2. Search for company 'AAPL' or use accession number directly")
        print(f"   3. Click 'Analyze' on any of the above filings")
        print(f"   4. The MVP should now work end-to-end!")
